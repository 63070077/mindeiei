...
<?php
$conn = mysqli_init();
mysqli_real_connect($conn, 'mindeiei@mindtanavich', 'mindeiei@mindtanavich', 'Kjom1234', 'itflab', 3306);
...
?>
        <tbody>
            ...
            <td>
                ...
                <a href="del.php?ID=<?php echo $Result['ID']?>" class="btn btn-danger"onclick="return confirm('Confirm data deletion?')">DELETE</a>
                </tr>
        </tbody>
<?php
}
?>
    ...
    <button type="button" class="btn btn-warning" onclick ="window.location.href='form.html'">ADD</button> 
<?php
mysqli_close($conn);
?>
    </body>
